...
if($category=='所有'){
	$sql = "SELECT * FROM publish where type='$type_t' order by publish_id desc;";
}else{	
	$sql = "SELECT * FROM publish where type='$type_t' and category='$category' order by publish_id desc;";
}
